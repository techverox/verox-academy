    ...
    <div className="max-w-4xl mx-auto space-y-12">
      ...
      <header className="flex items-center justify-between">
        <div>
          ...
          <h2 className="mt-4 text-4xl font-bold tracking-tight">Create New Course</h2>
        </div>
      </header>

      <form onSubmit={handleSubmit} className="space-y-10 rounded-5xl border border-zinc-200 bg-white p-12 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
        <div className="grid gap-10 md:grid-cols-2">
          {/* Title */}
          <div className="space-y-3">
            <label className="text-xs font-bold uppercase tracking-widest text-zinc-400">Course Title</label>
            <input
              type="text"
              required
        ...
        <div className="space-y-3">
          ...
          <textarea
            ...
            className="w-full rounded-4xl border border-zinc-100 bg-zinc-50 px-6 py-4 font-bold outline-none focus:border-zinc-900 dark:border-zinc-900 dark:bg-zinc-900/50 dark:focus:border-white transition-all resize-none"
        ...
        {/* Thumbnail URL */}
        <div className="space-y-3">
          <label className="text-xs font-bold uppercase tracking-widest text-zinc-400">Thumbnail Image URL</label>
          <input
            type="url"
            required
            className="w-full rounded-2xl border border-zinc-100 bg-zinc-50 px-6 py-4 font-bold outline-none focus:border-zinc-900 dark:border-zinc-900 dark:bg-zinc-900/50 dark:focus:border-white transition-all"
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full rounded-full bg-zinc-900 py-6 text-lg font-bold text-white shadow-2xl transition-all hover:scale-[1.01] active:scale-[0.98] disabled:opacity-50 dark:bg-white dark:text-black"
        >
